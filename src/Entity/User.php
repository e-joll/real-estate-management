...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Appointment::class, mappedBy: 'buyer')]
    private Collection $appointments;

    /**
     * @var Collection<int, Inquiry>
     */
    #[ORM\OneToMany(targetEntity: Inquiry::class, mappedBy: 'buyer')]
    ...
    public function removeAppointment(Appointment $appointment): static
    {
        if ($this->appointments->removeElement($appointment)) {
            ...
            if ($appointment->getBuyer() === $this) {
                $appointment->setBuyer(null);
            }
        }
    ...
    public function removeInquiry(Inquiry $inquiry): static
    {
        if ($this->inquiries->removeElement($inquiry)) {
            // set the owning side to null (unless already changed)
            if ($inquiry->getBuyer() === $this) {
                $inquiry->setBuyer(null);
            }
        }
